...
def check_pktloss(cursor):
	...
	for row in cursor:
		...
		if completed > 100 and total_hlpkt_calls / completed > 0.15:
			offenders.append([tg_id, (total_hlpkt_calls/completed) * 100])
...
#selects timestamp, tg_id, direction...etc from previous hour (first 1000 results ordered by total HPL calls)
...
print_fields(curs)
#print_hpl_rows(curs) """keep this line if you want to print some example rows"""
check_pktloss(curs)
